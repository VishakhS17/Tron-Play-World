...
export const metadata: Metadata = {
  ...
  description: "Read the Privacy Policy for i-Robox.",
};
    ...
    <section className="overflow-hidden py-10 pb-20">
      <div className="w-full px-4 mx-auto max-w-4xl sm:px-8 xl:px-0">
        ...
        <p className="text-base leading-7 text-meta-3 mb-5">
          ...
          processing the information collected by I-Robox, which also provides
          the reasons why we must collect certain personal data about you.
          Therefore, you must read this Privacy Policy before using I-Robox
          website.
        </p>

        <p className="text-base leading-7 text-meta-3 mb-10">
        ...
        <p className="text-base leading-7 text-meta-3 mb-10">
          When you visit the I-Robox, we automatically collect certain
        ...
        <p className="text-base leading-7 text-meta-3 mb-10">
          ...
          contact us via sunilaesi@gmail.com.
        </p>
        ...
        <ul className="list-disc pl-6 text-base leading-7 text-meta-3 mb-6 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-dark mb-4">Legal Disclosure</h2>
        <p className="text-base leading-7 text-meta-3 mb-10">
        ...
        <p className="text-base leading-7 text-meta-3">
          ...
          <a
            href="mailto:sunilaesi@gmail.com"
